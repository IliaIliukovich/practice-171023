...
import lesson20240513.refactoring.Bet;
import lesson20240513.refactoring.GainAlgorithm;
import lesson20240513.refactoring.Match;
...
public class GainAlgorithmTest {
    ...
    public void testAtLeastOneWinnerGetsNotNull() {
        for (int goalDifference = - MAX_GOAL_DIFFERENCE + 5; goalDifference < MAX_GOAL_DIFFERENCE + 1 + 5;
            ...
            match.setGoalsB(0);
            int winnerMoney = 0;
            betListResult = GainAlgorithm.getWinningBets(match, betList);
